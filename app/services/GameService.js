...
let _human = new Target(_humanConfigObj)
...
export default class GameService {
  ...
  //   _target.health -= _human.attacks[attackName]
  //   if (_target.health < 0) {
  //     _target.health = 0
  //   }
  // }
  ...
  function randomComputerAttack() {
      let keys = Object.keys(_target.attacks)
      ...
      if (computerChoice == 'slap') {
        _human.health = (_human.health - 10)
        ...
        playHealthBar.setAttribute("style",`width:${_human.health}%;` )
      }
      if (computerChoice == 'kick') {
        _human.health = (_human.health - 15)
      ...
      if (computerChoice == 'punch') {
        _human.health = (_human.health - 20)
...
// ???
  ...
  get HumanHealth() {
    return _human.health.toString()
  }

  reset() {
    _target.health = _target.maxHealth
    _human.health = _human.maxHealth
  }
}
